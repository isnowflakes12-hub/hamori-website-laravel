@extends('layouts.app')
@section('title', 'Fasilitas ' . $kategori->nama)
...
<div class="page-header">
    <div class="container">
        <h1 class="page-title">Fasilitas {{ $kategori->nama }}</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li>
                <li class="breadcrumb-item active">Fasilitas {{ $kategori->nama }}</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="fri-card">
                    ...
                    <div class="fri-body">
                        ...
                        <p class="fri-desc">
                            {{ Str::limit($f->deskripsi ?? 'Fasilitas medis unggulan dengan standar pelayanan terbaik.', 120) }}
                        </p>
            ...
            <div class="col-12 text-center py-5">
                <div style="font-size:3rem;color:#cbd5e1;margin-bottom:15px"><i class="fas fa-hospital-user"></i></div>
                <h4 class="fw-bold text-secondary">Belum Ada Data</h4>
                <p class="text-muted">Data fasilitas untuk kategori {{ $kategori->nama }} saat ini belum tersedia.</p>
            </div>
            @endforelse
        </div>
    </div>
